...
def main():
    ...
    for signal in unique_signals.keys():
        for signal_position in unique_signals[signal]:
            if signal_position not in antinodes:
                antinodes.append(signal_position)
